...
<TouchableOpacity>
<View style={{height:height*0.06, width:width*0.5, alignSelf:'center', justifyContent:'center',  borderRadius:4,top:35, flexDirection:'row', alignItems:'center',borderWidth:1, }}>
    <Image source={require("../../Images/Googlegoogle.png")} style={{right:4,}} />
...
<View style={{height:height*0.06, width:width*0.5, alignSelf:'center', justifyContent:'center', backgroundColor:'#0D65A0', borderRadius:4,top:55, flexDirection:'row', alignItems:'center', }}>
